	...
	app.post('/editSurvey', function (req, res, next) {
		passport.authenticate('local', function (err, user, info) {
			...
			if(typeof req.body.radio == 'undefined'){
				res.redirect('/surveyapp/my-surveys');
			}
			else if(req.body.start){
				res.redirect('/surveyapp/survey/' + req.body.radio);
			}
			else if(req.body.edit){
				res.redirect('/surveyapp/new-survey/' + req.body.radio);
			}
			else if(req.body.stat){
				res.redirect('/surveyapp/stats/' + req.body.radio);
			}
			else if(req.body.preview){
				res.redirect('/surveyapp/preview/' + req.body.radio);
			}
			else if(req.body.deleteFlag){
				res.redirect('/surveyapp/delete/' + req.body.radio);
			}
		})(req, res, next);
	});
